...
```
The .sqn files were submitted to NCBI but screening indicated annotation errors that were unable to be resolved. Instead the .fsa files were submitted to NCBI and annotation data made available at zenodo: DOI 10.5281/zenodo.15321350.
